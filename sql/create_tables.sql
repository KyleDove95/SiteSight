...
CREATE TABLE SS_tags
    ...
    FOREIGN KEY (userID) REFERENCES SS_users(userID)) ENGINE=INNODB;
...
CREATE TABLE SS_tiles
    ...
    FOREIGN KEY (userID) REFERENCES SS_users(userID),
	FOREIGN KEY (tag_name) REFERENCES SS_tags(tag_name)) ENGINE=INNODB;
